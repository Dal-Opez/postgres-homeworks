...
ALTER TABLE order_details DROP CONSTRAINT foreign_key_order_details_products;
ALTER TABLE order_details ADD CONSTRAINT foreign_key_order_details_products FOREIGN KEY(product_id) REFERENCES products(product_id) ON DELETE CASCADE;
